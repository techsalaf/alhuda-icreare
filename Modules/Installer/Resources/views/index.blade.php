...
$php_version_required_min = "7.3.0";
$php_version_required_max = "8.3.0";
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class=" col-md-9">
                                                <input type="text" value="{{old('dbuser') ?? ''}}" name="db_user" class="form-control" autocomplete="off" placeholder="Database user name" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label for="dbpassword" class=" col-md-3">Password</label>
                                            <div class=" col-md-9">
                                                <input type="password" value="{{old('dbpassword') ?? ''}}" name="db_password" class="form-control" autocomplete="off" placeholder="Database user password" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label for="dbname" class=" col-md-3">Database Name</label>
                                            <div class=" col-md-9">
                                                <input type="text" value="{{old('dbname') ?? ''}}" name="db_name" class="form-control" placeholder="Database Name" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
