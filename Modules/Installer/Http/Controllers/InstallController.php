    ...
    public function getInstall(InstallRequest $request)
{
    ...
    // if purchase code is not empty, skip verification
    ...
    elseif ($verification === 'connection_error') :
        return redirect()->back()->with('error', 'There is a problem to connect with SpaGreen server.Make sure you have an active internet connection!');
