          ...
          <div class="transition-fade" id="swup">
            ...
            <div id="scrollbar" class="art-scroll-frame">
                  ...
                  <div class="art-grid art-grid-2-col art-gallery">
                    ...
                    <div class="art-grid-item webTemplates">
                      ...
                      <div class="art-item-description">
                        ...
                        <!-- button -->
                        <a href="portfolio-single.php" class="art-link art-color-link art-w-chevron">Read more</a>
                      </div>
                      <!-- description end -->
              ...
              <div class="container-fluid">
                ...
                <footer>
                  <!-- copyright -->
                  <div class="art-copy">© 2023 Digital Dynamo</div>
                  <!-- author ( Please! Do not delete it. You are awesome! :) -->
                  <div>Software Developer:&#160; <a href="https://incentiveideas.webhostingfree.io" target="_blank"
                      data-no-swup>Amuda Rasheed</a></div>
                </footer>
                <!-- footer end -->
              ...
              <nav id="swupMenu">
                ...
                <ul class="main-menu">
                  ...
                  <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-2-col.php">2 column</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-3-col.php">3 column</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-2-col-masonry.php">2 column masonry</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-3-col-masonry.php">3 column masonry</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-single.php">Single project</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="portfolio-single-2.php">Single project 2</a></li>
                    </ul>
                    <!-- sub menu end -->
                  </li>
                  <!-- menu item -->
                  ...
                  <li class="menu-item menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="blog-2-col.php">2 column</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="blog-3-col.php">3 column</a></li>
                      <!-- lvl 2 nav link -->
                      <li class="menu-item"><a href="blog-post.php">Publication</a></li>
                    </ul>
                    <!-- sub menu end -->
                  </li>
                  <!-- menu item -->
                  <li class="menu-item"><a href="http://localhost/basma" target="_blank" data-no-swup>Portfolio 2</a>
                  </li>
                </ul>
                <!-- menu list end -->
              </nav>
