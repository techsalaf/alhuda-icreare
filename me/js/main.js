...
Name: 		Amuda Rasheed e-Portfolio
Version:  1.0
Author:		Amuda Rasheed (Incentive Ideas)
Portfolio:  https://me.incentiveids.com

p.s. I am available for Freelance hire (UI design, web development). mail: amudarash102@gmail.com
...
$(function () {
  ...
  var formSubmitted = false; // Variable to track form submission
  ...
  $("#form").submit(function (event) {
    ...
    $.ajax({
      ...
      formSubmitted = true; // Set formSubmitted to true after successful submission

      // Delay the redirection by 2 seconds (adjust as needed)
      setTimeout(function () {
        window.location.href = 'https://me.alhudainfocreare.com'; // Redirect to the index page
      }, 2000);
    });
  });
