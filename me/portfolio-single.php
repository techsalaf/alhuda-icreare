          ...
          <div class="transition-fade" id="swup">
            ...
            <div id="scrollbar" class="art-scroll-frame">
              ...
              <!-- client reviews container -->
                <?php include ('includes/portfolios/client-reviews.php');?>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <!-- call to action -->
                      <?php include ('includes/portfolios/call-to-action.php');?>
                    <!-- call to action end  -->

                    <!-- projects navigation -->
                    <div class="art-a art-pagination">
                      <!-- button -->
                      <a href="portfolio-single-2.php"
                        class="art-link art-color-link art-w-chevron art-left-link"><span>Previous project</span></a>
                      <div class="art-pagination-center art-m-hidden">
                        <a class="art-link" href="portfolio-3-col-masonry-2.php">All projects</a>
                      </div>
                      <!-- button -->
                      <a href="portfolio-single-2.php" class="art-link art-color-link art-w-chevron"><span>Next
                          project</span></a>
                    </div>
