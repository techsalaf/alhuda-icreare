                ...
                <div class="row p-30-0">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="art-a art-blog-card">
                      <!-- post cover -->
                      <a href="blog-post.php" class="art-port-cover">
                        <!-- img -->
                      ...
                      <div class="art-post-description">
                        ...
                        <!-- link -->
                        <a href="blog-post.php" class="art-link art-color-link art-w-chevron">Read more</a>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="art-a art-pagination">
                      <!-- button -->
                      <a href="blog-3-col.php"
                        class="art-link art-color-link art-w-chevron art-left-link"><span>Previous page</span></a>
                      <div class="art-pagination-center art-m-hidden">
                        <a href="blog-3-col.php"></a>
                        <a href="blog-3-col.php">1</a>
                        <a class="art-active-pag" href="blog-2-col.php">2</a>
                        <a href="blog-3-col.php">3</a>
                        <a href="blog-3-col.php">...</a>
                      </div>
                      <!-- button -->
                      <a href="blog-3-col.php" class="art-link art-color-link art-w-chevron"><span>Next page</span></a>
                    </div>
                    <!-- pagination end -->
