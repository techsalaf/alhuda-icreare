...
<div class="art-grid-item drawings">
  <!-- grid item frame -->
  <a data-fancybox="gallery" data-no-swup href="img/works/original-size/11.jpg"
  ...
  <div class="art-item-description">
    ...
    <!-- button -->
    <a href="includes/project-details/more-project-detail-11.php" class="art-link art-color-link art-w-chevron">Read more</a>
  </div>
  <!-- description end -->
</div>
<!-- grid item end -->
