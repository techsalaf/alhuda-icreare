                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <!-- price list end -->
                        <!-- button -->
                        <a href="contact.php" class="art-link art-color-link art-w-chevron">Order Now!</a>
                        <div class="art-asterisk"><sup>*</sup>Free only when ordering a paid service</div>
                      </div>
                      <!-- price body end -->
                    </div>
                    <!-- price end -->
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price art-popular-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <!-- price cost -->
                        <div class="art-price-cost">
                          <div class="art-number"><span>$</span>30<span>/h</span></div>
                        </div>
                        <!-- price cost end -->
                        <!-- price list -->
                        <ul class="art-price-list">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <!-- price cost -->
                        <div class="art-price-cost">
                          <div class="art-number"><span>$</span>1200<span>/m</span></div>
                        </div>
                        <!-- price cost end -->
                        <!-- price list -->
                        <ul class="art-price-list">
